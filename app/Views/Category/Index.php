                ...
                <?php if($pageNumber > 1){ ?>
                    <center>
                        <ul class="pagination">
                            <?php if ($pageNumber >=4){ ?>
                                <li>
                                    <a href="/category/?cat=<?php echo $cat; ?>&page=<?php echo ($page-1 >=1) ? $page-1 : '1'; ?>" aria-label="Previous">
                            ...
                            <?php for($i=1;$i<=$pageNumber;$i++){
                                if($i == 4){
                                    ...
                                    $html = sprintf("<li><a href='%s' aria-label='Next'><span aria-hidden='true'>&raquo;</span></a></li>",'/category/?cat='.$cat.'&page='.$nextPage);
                                    echo $html;
                                    break;
                                }
                                $html = sprintf("<li><a href='%s'>%d</a></li>",'/category/?cat='.$cat.'&page='.$i,$i);
                                echo $html;
                            } ?>
                        </ul>
                    </center>
